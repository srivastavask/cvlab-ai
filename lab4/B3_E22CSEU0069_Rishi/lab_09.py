...
Original file is located at
    https://colab.research.google.com/drive/1voL7nIDJswRDWvgNf0kkeBqlmVigdLC_
"""
...
image_path = "/content/73068-lamborghini-huracan-lamborghini-cars-hd-4k-need-for-speed-artstation.jpg"
...
img1 = cv2.imread("/content/73068-lamborghini-huracan-lamborghini-cars-hd-4k-need-for-speed-artstation.jpg")
img2 = cv2.imread("/content/Revulto.jpeg")

if img1 is None or img2 is None:
    raise FileNotFoundError("Could not load one or both of the images. Make sure 'img1.png' and 'img2.png' are in the correct directory.")
